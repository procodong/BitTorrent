...
internal class DownloadLauncher : IDownloadLauncher
{
    ...
    public PeerManagerHandle LaunchDownload(Download download, StorageStream storage, ITrackerFetcher tracker)
    {
        ...
        var launcher = new PeerLauncher(downloader, removalChannel.Writer, download.Data.PieceCount, blockStorage, _logger);
        ...
        var downloadController = new DownloadController(stateChannel.Writer, downloadState);
        return new PeerManagerHandle(downloadController, canceller, spawner, download);
    }
