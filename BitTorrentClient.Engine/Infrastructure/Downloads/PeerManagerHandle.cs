...
public readonly record struct PeerManagerHandle(DownloadState State, ChannelWriter<DownloadExecutionState> StateWriter, CancellationTokenSource Canceller, IPeerSpawner PeerSpawner, Task FinishedTask);
