...
public class PeerSpawner
{
    ...
    public async Task StartPeerAsync(PeerWireStream stream, int index, SharedPeerState state, ChannelReader<PeerRelation> relationReader, Channel<int> haveChannel)
    {
